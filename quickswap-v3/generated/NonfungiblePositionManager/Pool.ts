...
export class Pool__getInnerCumulativesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Pool__getTimepointsResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
  value2: Array<BigInt>;
  value3: Array<BigInt>;
...
export class Pool__swapSupportingFeeOnInputTokensResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pool__timepointsResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Pool extends ethereum.SmartContract {
  ...
  burn(bottomTick: i32, topTick: i32, amount: BigInt): Pool__burnResult {
    let result = super.call(
      "burn",
  ...
  getInnerCumulatives(
    bottomTick: i32,
    topTick: i32
  ): Pool__getInnerCumulativesResult {
    let result = super.call(
      "getInnerCumulatives",
    ...
    return new Pool__getInnerCumulativesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getInnerCumulatives(
    bottomTick: i32,
    topTick: i32
  ): ethereum.CallResult<Pool__getInnerCumulativesResult> {
    let result = super.tryCall(
      "getInnerCumulatives",
      "getInnerCumulatives(int24,int24):(int56,uint160,uint32)",
      [ethereum.Value.fromI32(bottomTick), ethereum.Value.fromI32(topTick)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__getInnerCumulativesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getTimepoints(secondsAgos: Array<BigInt>): Pool__getTimepointsResult {
    let result = super.call(
      "getTimepoints",
    ...
    return new Pool__getTimepointsResult(
  ...
  ): ethereum.CallResult<Pool__getTimepointsResult> {
    let result = super.tryCall(
      "getTimepoints",
      "getTimepoints(uint32[]):(int56[],uint160[],uint112[],uint256[])",
      [ethereum.Value.fromUnsignedBigIntArray(secondsAgos)]
  ...
  swapSupportingFeeOnInputTokens(
    ...
    limitSqrtPrice: BigInt,
    data: Bytes
  ): Pool__swapSupportingFeeOnInputTokensResult {
    let result = super.call(
      "swapSupportingFeeOnInputTokens",
    ...
    return new Pool__swapSupportingFeeOnInputTokensResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_swapSupportingFeeOnInputTokens(
    ...
    limitSqrtPrice: BigInt,
    data: Bytes
  ): ethereum.CallResult<Pool__swapSupportingFeeOnInputTokensResult> {
    let result = super.tryCall(
      "swapSupportingFeeOnInputTokens",
      "swapSupportingFeeOnInputTokens(address,address,bool,int256,uint160,bytes):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pool__swapSupportingFeeOnInputTokensResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  timepoints(index: BigInt): Pool__timepointsResult {
    let result = super.call(
      "timepoints",
    ...
    return new Pool__timepointsResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_timepoints(index: BigInt): ethereum.CallResult<Pool__timepointsResult> {
    let result = super.tryCall(
      "timepoints",
      "timepoints(uint256):(bool,uint32,int56,uint160,uint88,int24,uint144)",
      [ethereum.Value.fromUnsignedBigInt(index)]
