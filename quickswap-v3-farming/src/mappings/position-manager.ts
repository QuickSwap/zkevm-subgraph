...
import { FarmingCenterAddress, ZERO_BI } from '../utils/constants'
...
export function handleIncreaseLiquidity(event: IncreaseLiquidity): void {
  ...
  entity.L2tokenId = ZERO_BI;
  entity.tokensLockedLimit = ZERO_BI;
  entity.tokensLockedEternal = ZERO_BI;
  entity.tierLimit = ZERO_BI;
  entity.tierEternal = ZERO_BI;
  entity.save();
